...
<body>
	...
	<div class="row">
		...
		<div class="col-lg-4 col-xs-12" style="border-right: 2px solid #cccc">
		...
		<div class="col-lg-8 col-xs-12">
			...
			<h4 class="text-secondary" style="margin-top: 30px"> <i class="fas fa-info-circle"></i>&nbsp &nbspEdit Information</h4>	
